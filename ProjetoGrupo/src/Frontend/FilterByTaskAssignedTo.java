...
public class FilterByTaskAssignedTo extends javax.swing.JDialog {

    Sistema s;
    DefaultTableModel modelUsers, modelTasksCreatedBy;

    //construtor
    public FilterByTaskAssignedTo(java.awt.Frame parent, boolean modal, Sistema s) {
        super(parent, modal);
        initComponents();
        this.s = s;
        Validacoes.SetDialogProperties(this, s,  "Filtrar por Tarefas Atribuídas ao Utilizador Selecionado");
        ...
        tableUsers.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent event) {
                ...
                ArrayList<Task> TasksAssignedTo = s.getRepositoryTasks().getTasksAssignedToUser(UserId);
                for (Task taskAssignedTo : TasksAssignedTo) {
                    if (taskAssignedTo.getEndDate() != null) {
                        modelTasksCreatedBy.addRow(new Object[]{
                            taskAssignedTo.getTaskId(),
                            taskAssignedTo.getTitle(),
                            taskAssignedTo.getDescription(),
                            taskAssignedTo.getEnumPriority(),
                            taskAssignedTo.getEnumStatus(),
                            Validacoes.FormatDate(taskAssignedTo.getStartDate()),
                            Validacoes.FormatDate(taskAssignedTo.getEndDate())
                        });
                    } else {
                        modelTasksCreatedBy.addRow(new Object[]{
                            taskAssignedTo.getTaskId(),
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 222, -1, -1));
