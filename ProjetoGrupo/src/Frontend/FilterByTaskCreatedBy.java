...
public class FilterByTaskCreatedBy extends javax.swing.JDialog {

    Sistema s;
    DefaultTableModel modelUsers, modelTasksCreatedBy;

    //construtor
    public FilterByTaskCreatedBy(java.awt.Frame parent, boolean modal, Sistema s) {
        super(parent, modal);
        initComponents();
        this.s = s;
        Validacoes.SetDialogProperties(this, s, "Filtrar por Utilizador que criou tarefas");
        ...
        tableUsers.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent event) {
                ...
                ArrayList<Task> TasksCreatedBy = s.getRepositoryTasks().getTasksCreatedBy(UserId);
                for (Task tasktCreatedBy : TasksCreatedBy) {
                    if (tasktCreatedBy.getEndDate() != null) {
                        modelTasksCreatedBy.addRow(new Object[]{
                            tasktCreatedBy.getTaskId(),
                            tasktCreatedBy.getTitle(),
                            tasktCreatedBy.getDescription(),
                            tasktCreatedBy.getEnumPriority(),
                            tasktCreatedBy.getEnumStatus(),
                            Validacoes.FormatDate(tasktCreatedBy.getStartDate()),
                            Validacoes.FormatDate(tasktCreatedBy.getEndDate())
                        });
                    } else {
                        modelTasksCreatedBy.addRow(new Object[]{
                            tasktCreatedBy.getTaskId(),
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tarefas Atribuídas ao Utilizador Selecionado", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 0, 18))); // NOI18N
