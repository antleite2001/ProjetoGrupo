...
public class FilterByTaskEndDate extends javax.swing.JDialog {

    Sistema s;
    DefaultTableModel modelUsers, modelTasksCreatedBy;

    //construtor
    public FilterByTaskEndDate(java.awt.Frame parent, boolean modal, Sistema s) {
        super(parent, modal);
        initComponents();
        this.s = s;
        Validacoes.SetDialogProperties(this, s, 900, 800, "Filtrar por Data de Fim");
    ...
    void FillEndDateTable() {
        //Clear table
        modelTasksCreatedBy.setRowCount(0);

        //Display Tasks Created by user
        ArrayList<Task> tasksByStatus = s.getRepositoryTasks().getTasksByEndDate(calEndDate);
        for (Task taskByStatus : tasksByStatus) {
            if (taskByStatus.getEndDate() != null) {
                modelTasksCreatedBy.addRow(new Object[]{
                    ...
                    taskByStatus.getTaskPriority(),
                    taskByStatus.getTaskStatus(),
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tarefas Selecionadas por Data de Fim", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 0, 18))); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Selecionar Data de Fim", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 0, 18))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(calEndDate, javax.swing.GroupLayout.DEFAULT_SIZE, 224, Short.MAX_VALUE)
                .addContainerGap())
        );
